            ...
            <div class="menu-area">
                ...
                <div class="mainmenu">
                    <ul id="primary-menu">
            			...
            			<li><a class="active" href="search?content=&offset=0">搜索一览</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<section class="portfolio-area pt-1">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="details-thumb">
                        <div class="details-thumb-prev">
                            <div class="thumb-icon">
                                <a href="search?&content=${content}&offset=${lastOffset}"><i class="icofont icofont-simple-left"></i></a>
                            </div>
                        ...
                        <div class="details-thumb-next">
                            ...
                            <div class="thumb-icon">
                                <a href="search?&content=${content}&offset=${nextOffset}"><i class="icofont icofont-simple-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
